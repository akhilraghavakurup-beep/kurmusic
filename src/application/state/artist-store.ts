...
export function useArtistStationTracks(artistId: string): readonly Track[] {
	return useArtistStore((state) => state.artists.get(artistId)?.stationTracks ?? EMPTY_TRACKS);
}
