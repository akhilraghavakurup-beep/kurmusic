...
export const DEFAULT_PRESETS: EqualizerPreset[] = [
	...
	},
	{
		id: 'pop',
		name: 'Pop',
		gains: [-1, 1, 3, 4, 4, 3, 1, -1, -1, -1],
	},
	{
		id: 'dance',
		name: 'Dance',
		gains: [6, 5, 2, 0, 0, -2, -2, 0, 4, 5],
	},
	{
		id: 'party',
		name: 'Party',
		gains: [7, 6, 0, 0, 0, 0, 0, 0, 5, 6],
	},
	{
		id: 'deep-bass',
		name: 'Deep Bass',
		gains: [9, 8, 6, 3, 0, -2, -3, -2, 0, 1],
	},
	{
		id: 'lounge',
		name: 'Lounge',
		gains: [-3, -1, 2, 4, 3, 0, -1, 1, 3, 2],
	},
];
...
export const useEqualizerStore = create<EqualizerState>()(
	persist(
		...
		{
			name: '@kurmusic:equalizer-storage',
